...
const events = [
  {
    ...
    description: "24-hour coding marathon. Build, innovate, and win exciting prizes worth ₹50,000.",
    date: "2026-04-20",
    time: "09:00 AM",
  ...
  },
  {
    ...
    description: "Annual cultural extravaganza with dance, music, and theatrical performances.",
    date: "2026-04-25",
    time: "06:00 PM",
  ...
  },
  {
    ...
    description: "Hands-on 2-day workshop on Figma, prototyping, and design thinking with industry experts.",
    date: "2026-05-02",
    time: "10:00 AM",
  ...
  },
  {
    ...
    description: "Cricket, football, and badminton tournaments. Represent your department and win the trophy.",
    date: "2026-05-10",
    time: "08:00 AM",
    venue: "Sports Ground",
    totalSeats: 150,
...
const notifications = [
  {
    ...
    type: "order",
    title: "Order Ready! 🎉",
    message: "Your Chicken Cheese Burger & Cold Coffee are ready for pickup at Counter 3.",
    timestamp: "2 min ago",
    read: false
  },
  {
    ...
    message: "Only 43 seats left for TechFest 2026 Hackathon. Register now to secure your spot!",
  ...
  },
  {
    ...
    message: "Your Book Mart print order #BM-2891 (20 pages, B&W) is ready. Collect from Counter 1.",
  ...
  },
  {
    ...
    type: "promo",
    title: "Combo Tuesday 🍔",
    message: "Get Burger + Cold Coffee for just ₹150 today only at Vidhyarthi Khana. Valid 12–3 PM.",
  ...
  },
  {
    ...
    message: "Your order #VK-1042 has been placed successfully. Estimated wait: 12 minutes.",
    timestamp: "Yesterday",
    read: true
  }
];
...
const vendorCrowdIndicator = {
  level: "low",
  activeOrders: 3,
  avgWaitMinutes: 8,
  percentage: 30
};
const vendorTodaySummary = {
  pending: 4,
  preparing: 2,
  ready: 1,
  completed: 18,
...
export {
  vendorStats as a,
  vendorCrowdIndicator as b,
  vendorTodaySummary as c,
  events as e,
  foodItems as f,
  notifications as n,
  orderHistory as o,
  queueStatus as q,
  stationeryItems as s,
  userProfile as u,
  vendorOrders as v
};
