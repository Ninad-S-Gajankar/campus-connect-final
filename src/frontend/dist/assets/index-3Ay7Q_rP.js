const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Login-32geuq36.js","assets/CampusButton-DMSIN2t5.js","assets/CampusCard-0kLhwLfU.js","assets/mail-B_-LWaYW.js","assets/eye-BDDpskoM.js","assets/hash-DWRdpSxN.js","assets/Dashboard-D-kc1zIF.js","assets/CampusBadge-CTArW4kE.js","assets/index-C4jMyBpZ.js","assets/useCart-B49stm3y.js","assets/search-D7kHzjSm.js","assets/book-open-CrG-nRYC.js","assets/calendar-days-lS_gNOZ4.js","assets/map-pin-rhVvjT3q.js","assets/VendorDashboard-BUi6z4w9.js","assets/chef-hat-DRXCHD3U.js","assets/phone-B8vJ7TWR.js","assets/circle-check-x1WWCWkE.js","assets/users-CBy3q78o.js","assets/x-ALhsUHO1.js","assets/check-4L_L5t2K.js","assets/FoodCourt-D8irLF5c.js","assets/PageHeader-Phty1uEO.js","assets/plus-BqTfSro8.js","assets/Cart-CUcIQKzo.js","assets/OrderConfirmation-mmHeHpfa.js","assets/BookMart-WKpBlYs6.js","assets/EventBooking-w56V3eoN.js","assets/chevron-right-Cn6sTkZR.js","assets/Notifications-DztHAUw9.js","assets/QueueStatus-DG4swANe.js","assets/Profile-Cu7iYmCC.js"])))=>i.map(i=>d[i]);
...
const UIContext = reactExports.createContext(null);
function UIProvider({ children }) {
  const [hideBottomNav, setHideBottomNavState] = reactExports.useState(false);
  const setHideBottomNav = reactExports.useCallback((hide) => {
    setHideBottomNavState(hide);
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(UIContext.Provider, { value: { hideBottomNav, setHideBottomNav }, children });
}
function useUI() {
  const ctx = reactExports.useContext(UIContext);
...
function BottomNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-around px-1 py-2", children: navItems.map(({ to, label, icon: Icon2 }) => {
          ...
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `p-1.5 rounded-xl transition-smooth ${isActive ? "bg-primary/10 text-primary" : "text-muted-foreground group-hover:text-foreground"}`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 20, strokeWidth: isActive ? 2.5 : 1.8 })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: `text-[10px] font-medium leading-none transition-smooth truncate max-w-full ${isActive ? "text-primary" : "text-muted-foreground"}`,
                  children: label
                }
              )
            ]
...
function MobileLayout({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-[430px] min-h-screen relative flex flex-col bg-background overflow-x-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: `flex-1 ${navVisible ? "pb-[72px]" : ""}`, children }),
    navVisible && /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, {})
  ] }) });
}
const CartContext = reactExports.createContext(null);
function CartProvider({ children }) {
  const [items, setItems] = reactExports.useState([]);
  const addItem = reactExports.useCallback((foodItem) => {
    setItems((prev) => {
      const existing = prev.find((ci) => ci.foodItem.id === foodItem.id);
      if (existing) {
        return prev.map(
          (ci) => ci.foodItem.id === foodItem.id ? { ...ci, quantity: ci.quantity + 1 } : ci
        );
      }
      return [...prev, { foodItem, quantity: 1 }];
    });
  }, []);
  const removeItem = reactExports.useCallback((foodItemId) => {
    setItems((prev) => prev.filter((ci) => ci.foodItem.id !== foodItemId));
  }, []);
  const updateQuantity = reactExports.useCallback((foodItemId, quantity) => {
    if (quantity <= 0) {
      setItems((prev) => prev.filter((ci) => ci.foodItem.id !== foodItemId));
      return;
    }
    setItems(
      (prev) => prev.map(
        (ci) => ci.foodItem.id === foodItemId ? { ...ci, quantity } : ci
      )
    );
  }, []);
  const clearCart = reactExports.useCallback(() => setItems([]), []);
...
const SplashPage = reactExports.lazy(() => __vitePreload(() => import("./Splash-CFVYrSZG.js"), true ? [] : void 0));
const LoginPage = reactExports.lazy(() => __vitePreload(() => import("./Login-32geuq36.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0));
const DashboardPage = reactExports.lazy(() => __vitePreload(() => import("./Dashboard-D-kc1zIF.js"), true ? __vite__mapDeps([6,7,2,8,9,10,11,12,13]) : void 0));
const VendorDashboardPage = reactExports.lazy(() => __vitePreload(() => import("./VendorDashboard-BUi6z4w9.js"), true ? __vite__mapDeps([14,8,15,16,17,4,18,19,20,3,12]) : void 0));
const FoodCourtPage = reactExports.lazy(() => __vitePreload(() => import("./FoodCourt-D8irLF5c.js"), true ? __vite__mapDeps([21,7,2,22,8,9,10,23]) : void 0));
const CartPage = reactExports.lazy(() => __vitePreload(() => import("./Cart-CUcIQKzo.js"), true ? __vite__mapDeps([24,1,2,22,9,23]) : void 0));
const OrderConfirmationPage = reactExports.lazy(() => __vitePreload(() => import("./OrderConfirmation-mmHeHpfa.js"), true ? __vite__mapDeps([25,1,2,17,5]) : void 0));
const BookMartPage = reactExports.lazy(() => __vitePreload(() => import("./BookMart-WKpBlYs6.js"), true ? __vite__mapDeps([26,7,1,2,22,8,19,23,11]) : void 0));
const EventBookingPage = reactExports.lazy(() => __vitePreload(() => import("./EventBooking-w56V3eoN.js"), true ? __vite__mapDeps([27,7,1,2,22,8,20,13,18,28,19]) : void 0));
const NotificationsPage = reactExports.lazy(() => __vitePreload(() => import("./Notifications-DztHAUw9.js"), true ? __vite__mapDeps([29,7,2,22,8,12,20]) : void 0));
const QueueStatusPage = reactExports.lazy(() => __vitePreload(() => import("./QueueStatus-DG4swANe.js"), true ? __vite__mapDeps([30,7,2,22,8,5,15]) : void 0));
const ProfilePage = reactExports.lazy(() => __vitePreload(() => import("./Profile-Cu7iYmCC.js"), true ? __vite__mapDeps([31,7,1,2,8,28,16,19,20,3,11,12]) : void 0));
const queryClient$1 = new QueryClient();
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center min-h-[50vh]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 border-2 border-primary border-t-transparent rounded-full animate-spin" }) });
}
function AppShell() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) });
}
const rootRoute = createRootRoute({ component: AppShell });
const splashRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(MobileLayout, { showBottomNav: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(SplashPage, {}) }) })
});
const loginRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/login",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(MobileLayout, { showBottomNav: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoginPage, {}) }) })
});
const dashboardRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/dashboard",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(MobileLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardPage, {}) }) })
});
const vendorDashboardRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/vendor-dashboard",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(MobileLayout, { showBottomNav: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(VendorDashboardPage, {}) }) })
});
const foodCourtRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/food-court",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(MobileLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(FoodCourtPage, {}) }) })
});
const cartRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/cart",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(MobileLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(CartPage, {}) }) })
});
const orderConfirmationRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/order-confirmation",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(MobileLayout, { showBottomNav: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(OrderConfirmationPage, {}) }) })
});
const bookMartRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/book-mart",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(MobileLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookMartPage, {}) }) })
});
const eventBookingRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/event-booking",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(MobileLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(EventBookingPage, {}) }) })
});
const notificationsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/notifications",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(MobileLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationsPage, {}) }) })
});
const queueStatusRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/queue-status",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(MobileLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(QueueStatusPage, {}) }) })
});
const profileRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/profile",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(MobileLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProfilePage, {}) }) })
});
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient$1, children: /* @__PURE__ */ jsxRuntimeExports.jsx(UIProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CartProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { router }) }) }) });
}
